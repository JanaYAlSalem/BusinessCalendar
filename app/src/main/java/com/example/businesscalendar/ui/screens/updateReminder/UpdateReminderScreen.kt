...
fun UpdateReminderScreen(
    ...
    Column(
        ...
        CustomTextField(
            ...
            enabled = false,
            textValue = startDatePickerState.selectedDateMillis?.let { convertMillisToDate(it) }
                ?: "",
        ...
        CustomTextField(
            ...
            enabled = false,
            textValue = endDatePickerState.selectedDateMillis?.let { convertMillisToDate(it) }
                ?: "",
        ...
        Button(
            ...
            Text(color = Color.White, text = "Update")
        }
    }
}